...
The following image shows a sample execution of the BFS and A* algorithm,

including the solution path, path length, and number of expanded nodes.

![](example2.png)
![Algorithm Example Output](example.png)
